  ...
  return (
    ...
    <div className="aboutuspage">
      <div className="container">
          <div className="row">
            <div className="col-lg-10 m-auto col-12 float-start sm-padding-0">
              <div className="overview col-12 float-left">
