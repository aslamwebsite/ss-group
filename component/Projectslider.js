                                        ...
                                        <span className='srv_layer'></span>
                                            ...
                                            <figcaption>
                                                ...
                                                <p>{categoryData.homes.LuxuryResidences[index].location}</p> */}
                                                 <h4 dangerouslySetInnerHTML={{ __html: categoryData.homes.LuxuryResidences[index].ProjectName }} /><p dangerouslySetInnerHTML={{ __html: categoryData.homes.LuxuryResidences[index].location }} /><Link href={(categoryData.homes.LuxuryResidences[index].linkActive==1) ? "/projects/homes/" + categoryData.homes.LuxuryResidences[index].slug : ""}>
