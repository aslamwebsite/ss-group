          ...
          <div className="row">
            <div className="projectslickslider pb-3 mb-3">
              ...
              >
                ...
                categoryData.homes.OngoingProjects ? (
                  <>
                    <Slider {...settings}>
                      {categoryData.homes.LuxuryResidences &&
                        Object.keys(categoryData.homes.LuxuryResidences).map(
                          (pd1, index) => (
                            <div key={index}>
                              <div
                              ...
                              >
                                <figure className="snip0016">
                                  ...
                                  {categoryData.homes.LuxuryResidences[index]
                                    .imageSrc ? (
                                    <Image
                                      src={
                                        categoryData.homes.LuxuryResidences[
                      ...
                      {categoryData.homes.PremiumResidences &&
                        Object.keys(categoryData.homes.PremiumResidences).map(
                          (pd1, index) => (
                            <div key={index}>
                              <div
                                className={`projectslider`}
                              ...
                              >
                                <figure className="snip0016">
                                  <span className="srv_layer"></span>
                                  {categoryData.homes.PremiumResidences[index]
                                    .imageSrc ? (
                                    <Image
                                      src={
                                        categoryData.homes.PremiumResidences[
              ...
              >
                ...
                categoryData.retail.OngoingProjects ? (
                  <>
                    <Slider {...settings}>
                      {categoryData.retail.LuxuryResidences &&
                        Object.keys(categoryData.retail.LuxuryResidences).map(
                          (pd1, index) => (
                            <div key={index}>
                              <div
                                className={`projectslider`}
                              ...
                              >
                                <figure className="snip0016">
                                  <span className="srv_layer"></span>
                                  {categoryData.retail.LuxuryResidences[index]
                                    .imageSrc ? (
                                    <Image
                                      src={
                                        categoryData.retail.LuxuryResidences[
                      ...
                      {categoryData.retail.PremiumResidences &&
                        Object.keys(categoryData.retail.PremiumResidences).map(
                          (pd1, index) => (
                            <div key={index}>
                              <div
                                className={`projectslider`}
                              ...
                              >
                                <figure className="snip0016">
                                  <span className="srv_layer"></span>
                                  {categoryData.retail.PremiumResidences[index]
                                    .imageSrc ? (
                                    <Image
                                      src={
                                        categoryData.retail.PremiumResidences[
                      ...
                      {categoryData.retail.OngoingProjects &&
                        Object.keys(categoryData.retail.OngoingProjects).map(
                          (pd1, index) => (
                            <div key={index}>
                              <div
                                className={`projectslider`}
                              ...
                              >
                                <figure className="snip0016">
                                  <span className="srv_layer"></span>
                                  {categoryData.retail.OngoingProjects[index]
                                    .imageSrc ? (
                                    <Image
                                      src={
                                        categoryData.retail.OngoingProjects[
