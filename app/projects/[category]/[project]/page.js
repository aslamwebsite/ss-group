      ...
      {isComingSoon ? (
        ...
        <main className="d-flex flex-wrap float-start col-12 mt-3">
          ...
          {project.seotitle && project.seodesc ? (
            <ProjectContent
              seoheading={project.seoheading}
              seoTitle={project.seotitle}
              seoDesc={project.seodesc}
            />
          ) : null}
          <QuickLinks
            const_status={project.const_status}
            ebroucher={project.ebroucher}
                ...
                <div className="row">
                  <div className="web-container">
                    <div className="col-12 float-start prodisclaimer">
                      <p>
                        {" "}
                        <small>{project.disclaimer}</small>
                      </p>
                    </div>
                  </div>
                </div>
