...
import YouTube from "./svg-components/Youtube";
      ...
      <div className="navbar">
        <div className={menus ? "menus active" : "menus"}>
          <ul className="d-flex align-items-center toplinks">
            <li>
              <a className="col-12 float-start p-1">
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="leftbox d-flex pb-3">
                    <ul>
                      <li className="wrapper" onClick={handleToggle}>
                        <Link
                          href="/ss-group"
                  ...
                  <div className="col-lg-8 col-12">
                    <ul className="d-flex gap-4 text-uppercase sidemenus">
                      <li>
                        <Link href="/media/ad-campaigns" onClick={handleToggle}>
                          Media
                        </Link>
                      </li>
                      <li>
                        <Link href="/career" onClick={handleToggle}>
                          Career
                        </Link>
                      </li>
                      <li>
                        <Link href="/channel-partner" onClick={handleToggle}>
                          Channel Partner
                        </Link>
                      </li>
                    </ul>
                  ...
                  <div className="rightbox d-flex align-items-center">
                    <div className="address">
                      ...
                      <div className="addressbox">
                        <span>T</span>
                        <p>
                          <a href="tel:+911244335100">+91-124-4335100</a>
                        </p>
                      </div>
                    </div>
                    <div className="address">
                      <div className="addressbox">
                        <span>E</span>
                        <p>
                          <a href="mailto:sales@ssgroup-india.com">
                            sales@ssgroup-india.com
                          </a>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="followus">
                      <div className="title mb-2">
                        <span className="text-white border-0 p-0">
                          Follow Us
                        </span>
                      </div>
                      <ul className="d-flex p-0 gap-3">
                        <li className="p-0">
                          <a
                            className="lh-1 fs-1"
                            href="https://www.facebook.com/ssgrpindia"
                            target="_blank"
                          >
                            <Facebook />
                          </a>
                        ...
                        <li className="p-0">
                          <a
                            className="lh-1 fs-1"
                            href="https://www.instagram.com/ssgroup_in"
                            target="_blank"
                          >
                            <Instagram />
                          </a>
                        ...
                        <li className="p-0">
                          <a
                            className="lh-1 fs-1"
                            href="https://twitter.com/ssgroup_in"
                            target="_blank"
                          >
                            <Twitter />
                          </a>
                        ...
                        <li className="p-0">
                          <a
                            className="lh-1 fs-1"
                            href="https://linkedin.com/company/ssgroup-in"
                            target="_blank"
                          >
                            <LinkedIn />
                          </a>
                        ...
                        <li className="p-0">
                          <a
                            className="lh-1 fs-1"
                            href="https://www.youtube.com/channel/UCA8jVV5BI08cXXTIHGXag2w"
                            target="_blank"
                          >
                            <YouTube />
                          </a>
